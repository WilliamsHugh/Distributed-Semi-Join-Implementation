...
echo "Starting Node 3 (Employee Part 2) on port 8003..."
nohup uvicorn node3.main:app --port 8003 > node3.log 2>&1 &
...
echo "To view logs, you can check node1.log, node2.log, node3.log, and coordinator.log"
